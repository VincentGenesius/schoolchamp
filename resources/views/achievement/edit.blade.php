...
@section('content')
    <div class="bg-white border border-[#d9d9d9] p-5 text-[#333333]">
        <div class="mb-6 border-b border-gray-200 pb-2">
            <h1 class="text-xl font-bold">Edit Achievement</h1>
            <p class="text-sm">Update event details, participant information, or award results.</p>
        </div>
        ...
        <form action="" method="POST">
            ...
            <h1 class="border-l-3 border-[#990000] pl-2 mb-4 text-base font-bold">Event Details</h1>
